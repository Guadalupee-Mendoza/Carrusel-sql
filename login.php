...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .orb { position:absolute;border-radius:50%;filter:blur(90px);opacity:.3;animation:drift 14s ease-in-out infinite alternate; }
        ...
        .card {
            ...
            box-shadow: 0 8px 64px rgba(108,63,196,0.3);
        }
        ...
        .field label { display:block; font-weight:700; color:var(--lila); margin-bottom:7px; font-size:0.85rem; text-transform:uppercase; letter-spacing:.06em; }
        .field input {
        ...
        .error-msg {
            ...
            color:#ffaaaa; border-radius:12px; padding:12px 16px;
...
<body>
    ...
    <div class="card">
        ...
        <p class="sub">Accede al panel de tu galería</p>
        <?php if(isset($error)): ?>
        ...
        <a href="index.php" class="back-link">← Volver al carrusel</a>
    </div>
</body>
</html>
